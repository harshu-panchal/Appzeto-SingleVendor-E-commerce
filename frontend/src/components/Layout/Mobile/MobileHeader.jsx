      ...
      <div className="px-4 py-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link to="/app" className="flex items-center gap-2 flex-shrink-0">
            <div className="w-8 h-8 gradient-green rounded-lg flex items-center justify-center shadow-lg">
              <FiShoppingBag className="text-white text-lg" />
            </div>
            <span className="text-base font-bold text-gradient">Appzeto</span>
          </Link>
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-200 p-2 z-[60] min-w-[180px]">
                    ...
                    >
                      ...
                      <span className="font-medium text-gray-700 text-sm">Orders</span>
                    </Link>
                    <Link
                      to="/app/addresses"
                      onClick={() => setShowUserMenu(false)}
                    ...
                    >
                      ...
                      <span className="font-medium text-gray-700 text-sm">Addresses</span>
                    </Link>
                    <button
